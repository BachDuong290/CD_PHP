...
// lấy sp
$sql = "SELECT id, image, name, price, stock FROM products";
if ($category_id > 0) {
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <form class="d-flex" action="product.php" method="GET">
                    <input class="form-control me-2" type="search" name="search"
                        value="<?php echo htmlspecialchars($search); ?>" placeholder="Tìm kiếm sản phẩm...">
    ...
    <main class="container mt-3">
        <div class="row">
            ...
            <aside class="col-md-3">
                <div class="dropdown">
                    <a class="btn btn-primary dropdown-toggle w-100" type="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                    ...
                    <ul class="dropdown-menu w-100">
                        ...
                        <?php foreach ($categories as $category) { ?>
                            <li><a class="dropdown-item" href="product.php?category_id=<?php echo $category['id']; ?>">
            ...
            <section class="col-md-9">
                <h3 class="mb-3">
                    <?php
                    if (!empty($search)) {
                        echo 'Kết quả tìm kiếm cho: "<span class="text-primary">' . htmlspecialchars($search) . '</span>"';
                    } elseif ($category_id > 0) {
                        foreach ($categories as $category) {
                            if ($category['id'] == $category_id) {
                                echo "Danh mục: " . htmlspecialchars($category['name']);
                                break;
                            }
                        }
                    } else {
                ...
                <div class="row">
                    <?php
                    $product_list = !empty($search) ? $search_results : $products;
                        ...
                        foreach ($product_list as $product) { ?>
                            <div class="col-md-4 mb-4">
                                <div class="product-card">
                                    ...
                                    <p class="text-muted">Còn lại: <?php echo $product['stock']; ?> sản phẩm</p>
